...
public class XML_File{
    ...
    public XML_File(){
        doc = new XmlDocument(); 
        doc.Load("/Users/christiancontrerascampana/Desktop/project/unity_traffic_simulation/maps/A10-IN-1-19KM_HW_AC_DE_BER_RELEASE_20210510.xodr"); // ("CrossingComplex8Course.xml");  // ("BME.xml"); // ("Town01.xml");
    }
